...
public class BlockingQueue {
    public static void main(String[] args) {
        ...
        producer.start();
        consumer.start();
        java.util.concurrent.BlockingQueue<Integer> queue1 =  new LinkedBlockingQueue<>();
        ...
        java.util.concurrent.BlockingQueue<String> queue2 = new PriorityBlockingQueue<>(11, Comparator.reverseOrder());
        // unbounded
