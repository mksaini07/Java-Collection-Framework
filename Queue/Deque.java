...
public class Deque {
    public static void main(String[] args) {
        ...
        java.util.Deque<Integer> deque1 = new ArrayDeque<>(); // faster iteration, low memory, no null allowed
        ...
        java.util.Deque<Integer> deque2 = new LinkedList<>(); // insertion, deletion somewhere in middle
